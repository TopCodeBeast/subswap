...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("subswap"),
	impl_name: create_runtime_str!("plastic-beach"),
...
impl subswap_asset::Trait for Runtime {
	type Event = Event;
	type AssetId = AssetId;
}

impl subswap_market::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Asset: subswap_asset::{Module, Call, Storage, Event<T>},
		Market: subswap_market::{Module, Call, Storage, Event<T>}
	}
);
