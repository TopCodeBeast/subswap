...
decl_module! {
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        /// # </weight>
        #[weight = 0]
        fn issue(origin, #[compact] total: <T as balances::Trait>::Balance) {
...
decl_storage! {
    trait Store for Module<T: Trait> as Assets {
        ...
        Balances: map hasher(blake2_128_concat) (T::AssetId, T::AccountId) => <T as balances::Trait>::Balance;
...
impl<T: Trait> Module<T> {
    ...
    pub fn balance(id: T::AssetId, who: T::AccountId) -> <T as balances::Trait>::Balance {
        <Balances<T>>::get((id, who))
    }

    /// Get the total supply of an asset `id`.
    pub fn total_supply(id: T::AssetId) -> <T as balances::Trait>::Balance {
